...
const convertToLocalTime = (dateTimeString) => {
    ...
    return  localDateTime = new Date(utcDateTime.toLocaleString("en-US", {timeZone: "America/New_York"}))
...
onMounted(() => {
    ...
    emit('saveTask', { 
        ...props.task, 
        createdOn: convertToLocalTime(props.task.createdOn),
        updatedOn: convertToLocalTime(props.task.updatedOn)
                ...
                <div class="grid grid-cols-12 gap-[3vh]">
                    <div class="grid col-span-8">
                        <div>
                            ...
                            <textarea id="description" v-model="task.description" rows="20"
                    ...
                    <div class="grid col-span-4">
                        <div>
                            <div>
                                ...
                                <textarea id="assignees" v-model="task.assignees" rows="5"
                            ...
                            <div class="pt-[4vh]">
                                ...
                                <p>Last Updated On: {{ task.updatedOn }}</p>
                            </div>

                            <div class="pt-[4vh] flex justify-evenly">
                                <button class="btn btn-success btn-xs sm:btn-sm md:btn-md lg:btn-lg">Confirm</button>
