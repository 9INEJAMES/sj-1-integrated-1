...
<template>
    <div v-if="toastStore.currToast.header.length > 0" class="toast toast-start toast-top transition-opacity">
        <div class="alert text-white text-center" :class="toastStore.currToast.style">
            <span class="text-xl font-semibold">{{ toastStore.currToast.header }}:</span>
            <div v-show="toastStore.currToast.header == 'Loading'">
