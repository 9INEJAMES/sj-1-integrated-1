    ...
    <div class="fixed inset-0 flex justify-center items-center bg-black bg-opacity-50 w-full">
        <div class="my-[10vh] mx-[10vh] h-fit w-full rounded-lg" :class="themeStore.getTheme()">
            <div class="itbkk-modal-status grid gap-[2vh] rounded-md border-none p-[2vh]">
                ...
                <hr />
                <div>
                    <label for="statusName" :class="themeStore.getTextHeaderTheme()">Status Name<span
                            class="text-red-600">*</span></label><br />
                    <input type="text" name="statusName" id="statusName" @input="checkLength('name', newStatus.name, 50)"
                    ...
                    <p v-show="newStatus.name.length == 50" class="text-xs pl-3 pt-1 absolute overflow-auto">The name has a
                        maximum length of 50 characters.</p>
                </div>
                ...
                <div class="grid grid-cols-12 gap-[3vh] pt-2">
                    ...
                    <div class="flex col-span-4 flex-col justify-between">
                        ...
                        <div>
                            ...
                            <div
                                class="border h-20 w-30 flex justify-center items-center border-slate-300 font-bold text-black rounded-md">
