...
const onSubmit = async () => {
    try {
        ...
        const editedTask = {
            ...
            description: !selectedTask.value.description ? (selectedTask.value.description = '') : selectedTask.value.description,
            assignees: !selectedTask.value.assignees ? (selectedTask.value.assignees = '') : selectedTask.value.assignees,
        ...
        <div class="bg-white w-full rounded-lg">
            <div v-if="foundTask">
                <form class="grid gap-[2vh] rounded-md border-none p-[2vh]" @submit.prevent="onSubmit()">
                    <input type="text" name="title" class="font-bold text-[4vh]" id="title" v-model="selectedTask.title" />
                    <hr />
                        ...
                        <div class="grid col-span-4">
                            <div>
                                ...
                                <div class="pt-[4vh] flex justify-evenly">
                                    <button type="submit" class="btn btn-success btn-xs sm:btn-sm md:btn-md lg:btn-lg" @click="onSubmit()">Confirm</button>
