    ...
    <div class="w-full rounded-lg" :class="myTheme.getTheme()">
      <div class="grid gap-[2vh] rounded-md border-none p-[2vh]">
        <p class="text-xl font-semibold">
          {{ route.params.taskId ? 'Edit' : 'New' }} Task
        </p>
        <hr />
        <div>
          ...
          <input
            ...
            :disabled="isDisibled"
            :class="
              newTask.title.length === 100 ? 'text-gray-500' : 'text-gray-900'
            "
          />
          <p
            v-show="newTask.title.length === 100"
            class="pt-2 pl-4 text-xs text-gray-500 absolute"
          >
            The title have a maximum length of 100 characters.
          </p>
        </div>
          ...
          <div class="flex col-span-4 flex-col justify-between">
            <div>
              ...
              <div class="flex flex-col pt-[3vh]">
                ...
                <select
                  id="status"
                  class="itbkk-status select select-bordered disabled:text-white"
            ...
            <div class="pt-[4vh]">
              ...
              >
                ...
                <button
                  class="itbkk-button-cancel btn btn-error btn-xs sm:btn-sm md:btn-md lg:btn-lg"
              ...
              <div v-else class="flex justify-end items-end">
                <button
                  class="itbkk-button-close btn btn-error text-white"
                  @click="submitTask(false)"
                >
                  close
                </button>
